...
public class FantasticVertexConsumerProvider extends VertexConsumerProvider.Immediate implements FlushableVertexConsumerProvider, MemoryTrackingBuffer {
	...
	private boolean isTransparent(RenderLayer layer) {
		...
		// TODO: Support iris wrapped render layers
		/*
	...
	public int getAllocatedSize() {
		return transparent.getAllocatedSize() + opaque.getAllocatedSize();
	}

	@Override
	public int getUsedSize() {
		return transparent.getUsedSize() + opaque.getUsedSize();
	}
}
